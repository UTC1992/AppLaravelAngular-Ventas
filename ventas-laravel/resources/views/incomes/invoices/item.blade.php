<tr id="item-row-{{ $item_row }}">
    ...
    <td {{ $errors->has('item.' . $item_row . '.quantity') ? 'class="has-error"' : '' }}>
        ...
        <input value="{{ empty($item) ? '' : $item->quantity }}" class="form-control text-center cantidad-items" required="required" name="item[{{ $item_row }}][quantity]" type="text" id="item-quantity-{{ $item_row }}">
